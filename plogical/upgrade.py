...
class Upgrade:
    ...
    AdminACL = (
        '{"adminStatus":1, "versionManagement": 1, "createNewUser": 1, "listUsers": 1, "deleteUser":1 , "resellerCenter": 1, '
    ...
    ResellerACL = (
        '{"adminStatus":0, "versionManagement": 1, "createNewUser": 1, "listUsers": 1, "deleteUser": 1 , "resellerCenter": 1, '
    ...
    UserACL = (
        '{"adminStatus":0, "versionManagement": 1, "createNewUser": 0, "listUsers": 0, "deleteUser": 0 , "resellerCenter": 0, '
    ...
    def FindOperatingSytem():
        ...
        if os.path.exists(Upgrade.CentOSPath):
            ...
            if (
                result.find("CentOS Linux release 8") > -1
                or result.find("CloudLinux release 8") > -1
            ):
                return CENTOS8
            else:
                return CENTOS7
        ...
        try:
            ...
            while True:
                ...
                if res != 0:
                    count = count + 1
                    Upgrade.stdOut(
                        component + " failed, trying again, try number: " + str(count),
                        0,
                    )
                    if count == 3:
    ...
    def download_install_phpmyadmin():
        try:
            ...
            data = open(
                "/usr/local/CyberCP/public/phpmyadmin/config.sample.inc.php", "r"
            ).readlines()
...
"""
            ...
            try:
                ...
                command = (
                    "sed -i 's|localhost|%s|g' /usr/local/CyberCP/public/phpmyadmin/phpmyadminsignin.php"
                    % (mysqlhost)
                )
                Upgrade.executioner(command, 0)
...
"""
    ...
    def staticContent():
        ...
        command = (
            "/usr/local/CyberPanel/bin/python manage.py collectstatic --noinput --clear"
        )
        Upgrade.executioner(command, "Remove old static content", 0)
    ...
    def applyLoginSystemMigrations():
        try:
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD token varchar(500)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD secretKey varchar(50) DEFAULT 'None'"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD state varchar(15) DEFAULT 'ACTIVE'"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD securityLevel integer DEFAULT 1"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD twoFA integer DEFAULT 0"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD acl_id integer"
                )
            except:
                pass
            try:
            ...
            try:
                cursor.execute(
                    "insert into loginSystem_acl (id, name, adminStatus) values (1,'admin',1)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "UPDATE loginSystem_administrator SET  acl_id = 1 where userName = 'admin'"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "UPDATE loginSystem_acl SET config = '%s' where name = 'admin'"
                    % (Upgrade.AdminACL)
                )
            except BaseException as msg:
                print(str(msg))
            ...
            try:
                cursor.execute(
                    "UPDATE loginSystem_acl SET config = '%s' where name = 'reseller'"
                    % (Upgrade.ResellerACL)
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "UPDATE loginSystem_acl SET config = '%s' where name = 'user'"
                    % (Upgrade.UserACL)
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "alter table loginSystem_administrator drop initUserAccountsLimit"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE `websiteFunctions_aliasdomains` ADD COLUMN `master_id` integer NOT NULL"
                )
            except:
                pass
            try:
            ...
            try:
                cursor.execute(
                    "ALTER TABLE websiteFunctions_websites ADD config longtext"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE websiteFunctions_websites MODIFY externalApp varchar(30)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE emailMarketing_smtphosts MODIFY userName varchar(200)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE emailMarketing_smtphosts MODIFY password varchar(200)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE websiteFunctions_backups MODIFY fileName varchar(200)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_acl ADD COLUMN listUsers INT DEFAULT 0;"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_acl ADD COLUMN listEmails INT DEFAULT 1;"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_acl ADD COLUMN listPackages INT DEFAULT 0;"
                )
            except:
                pass
  ...
  CONSTRAINT `s3Backups_backuplogs_owner_id_f19e1736_fk_s3Backups` FOREIGN KEY (`owner_id`) REFERENCES `s3Backups_backupplanminio` (`id`)
    ...
    def mailServerMigrations():
        try:
            ...
            try:
                cursor.execute("ALTER TABLE e_users ADD mail varchar(200)")
            except:
                pass

            try:
                cursor.execute("ALTER TABLE e_users MODIFY password varchar(200)")
            except:
                pass
  ...
  CONSTRAINT `dockerManager_contai_admin_id_58fb62b7_fk_loginSyst` FOREIGN KEY (`admin_id`) REFERENCES `loginSystem_administrator` (`id`)
            ...
            try:
                cursor.execute(
                    "ALTER TABLE loginSystem_administrator ADD config longtext"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE dockerManager_containers ADD volumes longtext"
                )
            except:
                pass
  ...
  CONSTRAINT `CLManager_clpackages_owner_id_9898c1e8_fk_packages_package_id` FOREIGN KEY (`owner_id`) REFERENCES `packages_package` (`id`)
            ...
            query = (
                "ALTER TABLE packages_package ADD COLUMN allowFullDomain INT DEFAULT 1;"
            )
            try:
                cursor.execute(query)
            except:
  ...
  PRIMARY KEY (`id`)
            ...
            try:
                cursor.execute(
                    "alter table manageServices_pdnsstatus add masterServer varchar(200)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "alter table manageServices_pdnsstatus add masterIP varchar(200)"
                )
            except:
                pass
            ...
            try:
                cursor.execute(
                    "ALTER TABLE `manageServices_pdnsstatus` CHANGE `type` `type` VARCHAR(10) NULL;"
                )
            except:
                pass
  ...
  PRIMARY KEY (`id`)
    ...
    def GeneralMigrations():
        try:
            ...
            command = "/usr/local/CyberPanel/bin/python manage.py makemigrations"
            Upgrade.executioner(
                command, "/usr/local/CyberPanel/bin/python manage.py migrate", 0
            )
  ...
  CONSTRAINT `websiteFunctions_gdr_owner_id_4cf7983e_fk_websiteFu` FOREIGN KEY (`owner_id`) REFERENCES `websiteFunctions_gdrive` (`id`)
    ...
    'rootdb': {
        ...
        'PORT': '%s',
            ...
            if (
                currentBranch.find("On branch %s" % (branch)) > -1
                and currentBranch.find("On branch %s-dev" % (branch)) == -1
            ):
    ...
    def installLSCPD(branch):
        try:
            ...
            command = (
                "cp -f /usr/local/CyberCP/lscpd-0.3.1 /usr/local/lscp/bin/lscpd-0.3.1"
            )
            Upgrade.executioner(command, command, 0)
    ...
    def download_and_install_rclone():
        try:
            ...
            if os.path.exists("/usr/bin/rclone"):
                # return 0
                command = "rclone selfupdate --stable"
                Upgrade.executioner(command, 0)
...
?>""" % (
            ...
            clScripts = [
                "/usr/local/CyberCP/CLScript/panel_info.py",
            ...
            if os.path.exists(Upgrade.CentOSPath) or os.path.exists(
                Upgrade.openEulerPath
            ):
    ...
    def installPHP73():
        try:
            if Upgrade.installedOutput.find("lsphp73") == -1:
                command = (
                    "yum install -y lsphp73 lsphp73-json lsphp73-xmlrpc lsphp73-xml lsphp73-tidy lsphp73-soap lsphp73-snmp "
            ...
            if Upgrade.installedOutput.find("lsphp74") == -1:
                command = (
                    "yum install -y lsphp74 lsphp74-json lsphp74-xmlrpc lsphp74-xml lsphp74-tidy lsphp74-soap lsphp74-snmp "
    ...
    def upgradeDovecot():
        try:
            ...
            if (
                Upgrade.FindOperatingSytem() == CENTOS8
                or Upgrade.FindOperatingSytem() == CENTOS7
                or Upgrade.FindOperatingSytem() == openEuler22
                or Upgrade.FindOperatingSytem() == openEuler20
            ):
...
"""
    ...
    def runSomeImportantBash():
        ...
        # Remove invalid crons from /etc/crontab Reference: https://github.com/josephgodwinkimani/cyberpanel/issues/216
...
"""
    ...
    def upgrade(branch):
        ...
        if os.path.exists(Upgrade.CentOSPath) or os.path.exists(Upgrade.openEulerPath):
            ...
            Upgrade.installedOutput = subprocess.check_output(
                shlex.split(command)
            ).decode()
        else:
            command = "apt list"
        ...
        if os.path.exists(imunifyAVPath):
            execPath = (
                "/usr/local/CyberCP/bin/python /usr/local/CyberCP/CLManager/CageFS.py"
            )
